...
export const reclamationsEnseignantSlice = createApi({
  ...
  baseQuery: fetchBaseQuery({
    baseUrl: `${process.env.REACT_APP_API_URL}/api/reclamation-enseignant/`,
  }),
  tagTypes: ["Reclamations"],
  endpoints(builder) {
    return {
      fetchReclamationsEnseignant: builder.query<
        Reclamation[],
      ...
      deleteManyReclamationEnseignant: builder.mutation<
        Reclamation,
