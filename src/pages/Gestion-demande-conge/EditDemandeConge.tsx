...
const EditDemandeConge = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    fileInterruptionBase64String:
      demandeConge.fileInterruptionBase64String || "",
  });
  ...
  const handleStatusChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setFormData({
      ...
      dateInterruption:
        newStatus === "suspendue" ? formData.dateInterruption : "",
    });
  };

  const handleDateSuspensionChange = (
    e: React.ChangeEvent<HTMLInputElement>
  ) => {
    setFormData({
      ...formData,
      dateInterruption: e.target.value,
      fileInterruption: e.target.value,
    });
  };
                ...
                <Card.Body>
                  <Row className="mb-3">
                    <Col lg={6}>
                      <h6>Personnel:</h6>
                      <p>
                        {demandeConge.personnelId?.prenom_fr}{" "}
                        {demandeConge.personnelId?.nom_fr} |{" "}
                  ...
                  <Row className="mb-3">
                    <Col lg={6}>
                      ...
                      <p>
                        {demandeConge.startDay
                          ? new Date(demandeConge.startDay).toLocaleDateString(
                              "fr-FR"
                            )
                          : "N/A"}
                      </p>
                    ...
                    <Col lg={6}>
                      ...
                      <p>
                        {demandeConge.endDay
                          ? new Date(demandeConge.endDay).toLocaleDateString(
                              "fr-FR"
                            )
                          : "N/A"}
                      </p>
                    ...
                    {demandeConge.status === "acceptée" ? (
                      ...
                      <>
                        <Col lg={6}>
                          ...
                          <p>{demandeConge.dateInterruption}</p>
                          <h6>Piece-jointe:</h6>
                          <p>{demandeConge.fileInterruption}</p>
                        </Col>
                      </>
                    ) : (
                      <Col lg={6}>
                    ...
                    <Row className="mt-3">
                      <Col lg={6}>
                        ...
                        <Flatpickr
                          ...
                          value={
                            formData.dateInterruption
                              ? new Date(formData.dateInterruption)
                              : undefined
                          }
