    ...
    try {
      await MySwal.fire({
        ...
        if (result.isConfirmed) {
          ...
          MySwal.fire("Deleted!", "La réclamation a été supprimée.", "success");
        }
      });
    } catch (error) {
    ...
    () => [
      {
        Header: "Etudiant",
        accessor: (row: any) =>
          `${row.studentId?.prenom_fr || ""} ${row.studentId?.nom_fr || ""}`,
        disableFilters: true,
        filterable: true,
      },
      {
        ...
        accessor: (cellProps: any) => {
          return (
            <ul className="hstack gap-2 list-unstyled mb-0">
              {actionAuthorization(
                "/reclamation-etudiant/single-reclamation-etudiant",
                user?.permissions!
              ) ? (
                <li>
                  <Link
              ...
              {actionAuthorization(
                "/reclamation-etudiant/edit-reclamation-etudiant",
                user?.permissions!
              ) ? (
                <li>
                  <Link
              ...
              {actionAuthorization(
                "/reclamation-etudiant/supprimer-reclamation-etudiant",
                user?.permissions!
              ) ? (
                <li>
                  <Link
