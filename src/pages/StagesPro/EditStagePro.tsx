...
import { useUpdateStageProMutation } from "features/stagesPro/stagesProSlice";
...
function convertDateFormat(dateStr: any): string {
...
const EditStagePro = () => {
  document.title = "Modifier Stage Professionnel | ENIGA";
  ...
  const [updateStage] = useUpdateStageProMutation();
  ...
  const basePath = `${process.env.REACT_APP_API_URL}/files/stagePro`;
                  ...
                  <Col>
                    ...
                    > */}
                      ...
                      {stageDetails.type_stage === "Stage Technicien" ? (
                        <p className="mt-1">Proposition Stage Technicien</p>
                      ) : (
                        <p className="mt-1">Proposition Stage Ouvrier</p>
                      )}
                    </PDFDownloadLink>
                  </Col>
                  <Col>
                    ...
                    >
                      ...
                      ></i>
                      {stageDetails.type_stage === "Stage Technicien" ? (
                        <p className="mt-1">Affectation Stagiaire Technicien</p>
                      ) : (
                        <p className="mt-1">Affectation Stagiaire Ouvrier</p>
                      )}
                    </span>
                  </Col>
                </Row>
