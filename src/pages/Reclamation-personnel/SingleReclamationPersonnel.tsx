...
const SingleReclamationPersonnel = () => {
  ...
  const videoUrl = location.state?.video
    ? `${process.env.REACT_APP_API_URL}/files/reclamationPersonnelFiles/video/${location.state.video}`
    : "";
                          ...
                          <div className="card-header d-flex align-items-center">
                            ...
                            <div className="flex-shrink-0">
                              <Button
                                onClick={() =>
                                  navigate(
                                    `/gestion-personnel/compte-personnel`,
                                    {
                                      state: {
                                        _id: location.state?.personnelId._id,
                                      },
                                    }
                                  )
                                }
