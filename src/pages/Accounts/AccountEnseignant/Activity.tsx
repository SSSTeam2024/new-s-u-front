              ...
              <SimpleBar data-simplebar style={{ maxHeight: "440px" }}>
                <div className="acitivity-timeline acitivity-main">
                  ...
                  <div className="acitivity-item py-3 d-flex">
                    ...
                    <div className="flex-grow-1 ms-3">
                      <h6 className="mb-0 lh-base">
                        Today offers by{" "}
                        <Link to="/seller-overview" className="link-secondary">
                          themesbrand
                        </Link>
                      </h6>
                      <p className="mb-2 text-muted">
                        <small>03:14 PM - 18 Jan, 2023</small>
                      </p>
                      <p className="text-muted mb-0">
                  ...
                  <div className="acitivity-item py-3 d-flex">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <div className="d-inline-flex gap-2 border border-dashed p-2">
                        <Link
                          to="#"
                          className="bg-success-subtle rounded p-3 avatar-md flex-shrink-0"
                        >
                          <img
                            src={img4}
                            alt=""
                        ...
                        <Link
                          to="#"
                          className="bg-warning-subtle rounded p-3 avatar-md flex-shrink-0"
                        >
                          <img
                            src={img6}
                            alt=""
                        ...
                        <Link
                          to="#"
                          className="bg-info-subtle rounded p-3 avatar-md flex-shrink-0"
                        >
                          <img
                            src={img7}
                            alt=""
                  ...
                  <div className="acitivity-item py-3 d-flex">
                    ...
                    <div className="flex-grow-1 ms-3">
                      <h6 className="mb-0 lh-base">
                        Alina Holland have bookmark the products
                      </h6>
                      <p className="mb-2 text-muted">
                        <small>04:30 AM - 29 Dec, 2022</small>
                      </p>
                      <p className="text-muted mb-0">
                        Allow users to bookmark products in your WooCommerce
                        store.
                      </p>
                    </div>
                  </div>
                  <div className="acitivity-item py-3 d-flex">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <p className="mb-2 text-muted">
                        <small>01:14 PM - 24 Nov, 2022</small>
                      </p>
                      <p className="text-muted mb-0">
                        Kristina Hooper have favorited product.
                      </p>
                    </div>
                  </div>
                  <div className="acitivity-item py-3 d-flex">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <p className="mb-2 text-muted">
                        <small>11:15 AM - 29 Oct, 2022</small>
                      </p>
                      <p className="text-muted mb-0">
                        Flash sale by{" "}
                  ...
                  <div className="acitivity-item py-3 d-flex">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <p className="mb-2 text-muted">
                        <small>04:57 PM - 11 Sep, 2022</small>
                      </p>
                      <p className="text-muted mb-0">
                  ...
                  <div className="acitivity-item d-flex">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <p className="mb-2 text-muted">
                        <small>04:57 PM - 26 Aug, 2022</small>
                      </p>
