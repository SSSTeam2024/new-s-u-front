...
import { useFetchDemandePersonnelByIdQuery, useHandleDemandePersonnelMutation, useUpdateDemandePersonnelMutation } from "features/demandePersonnel/demandePersonnelSlice";
...
const SingleDemandePersonnel = () => {
  ...
  const [handleDemande, { isLoading, isSuccess }] = useHandleDemandePersonnelMutation();
  const [updateDemande, { isLoading: isUpdateLoading, isSuccess: isUpdateCompleted }] = useUpdateDemandePersonnelMutation();
                    ...
                    <table className="table table-sm table-borderless align-middle description-table mb-0">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <span className="mb-1 fs-5">
                              {state.state?.added_by! === null ? state.state?.enseignantId?.nom_fr! + " " + state.state?.enseignantId?.prenom_fr! : "Admin " + state.state?.added_by?.login!}
                            </span>
                          </td>
                        </tr>
                      </tbody>
                                          ...
                                          <Form.Group className="mb-0">
                                            ...
                                            <Button
                                              ...
                                              onClick={() => {
                                                ...
                                                const fileUrl = `${process.env.REACT_APP_API_URL}/files/demandePersonnel/${docName}`;
                                                window.open(fileUrl, '_blank', 'noopener,noreferrer');
                                              }}
                                            >
                                              <i className="bi bi-file-earmark-pdf label-icon align-middle fs-16 me-2"></i>
