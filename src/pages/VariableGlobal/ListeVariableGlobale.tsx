...
const ListeVariablesGlobales = () => {
  ...
  //     { index: number; changes: Record<string, unknown> }[]
  ...
  const modifications = useMemo(() => {
    ...
    >((acc, current: any, index) => {
      ...
      Object.keys(current).forEach((key) => {
        const previousValue = previous[key]; // Get previous value
        const currentValue = current[key]; // Get current value

        // Special case for 'places' to avoid false detection
        if (key === "places") {
          if (JSON.stringify(previousValue) !== JSON.stringify(currentValue)) {
            changes[key] = currentValue; // Store only if there are real changes
          }
        } else if (currentValue !== previousValue) {
          changes[key] = currentValue; // Store only changed values
        }
      });
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumb
            title="Liste des variables globales"
            pageTitle="Variables globales"
          />
        ...
        {modifications
          ...
          .map(({ index, changes }, i) => {
            ...
            return (
              <div
                key={index}
                className="card shadow-sm p-3 border border-warning"
              >
                                  ...
                                  {Array.isArray(previousValue) ? (
                                    previousValue.map((place, idx) => (
                                      <div key={idx}>
                                        ...
                                        <p>
                                          <strong>Rayon:</strong> {place.rayon}{" "}
                                          m
                                        </p>
                                      </div>
                                    ))
                ...
                <div className="row">
                    ...
                    <table className="table table-bordered">
                      <tbody>
                        <tr>
                          ...
                          <td>{lastVariable.etablissement_fr}</td>
                        </tr>
                        <tr>
                          <td>
                            <strong>Université</strong>
                          </td>
                          <td>{lastVariable.universite_fr}</td>
                        </tr>
                        <tr>
                          <td>
                            <strong>Directeur</strong>
                          </td>
                          <td>{lastVariable.directeur_fr}</td>
                        </tr>
                        <tr>
                          <td>
                            <strong>Secrétaire général</strong>
                          </td>
                          <td>{lastVariable.secretaire_fr}</td>
                        </tr>
                        <tr>
                          <td>
                            <strong>Gouvernorat</strong>
                          </td>
                          <td>{lastVariable.gouvernorat_fr}</td>
                        </tr>
                        <tr>
                          <td>
                            <strong>Adresse</strong>
                          </td>
                          <td>{lastVariable.address_fr}</td>
                        </tr>
                        <tr>
                          <td>
                            <strong>Code Postal</strong>
                          </td>
                          <td>{lastVariable.code_postal}</td>
                        </tr>
                        <tr>
                          <td>
                            <strong>Téléphone</strong>
                          </td>
                          <td>{lastVariable.phone}</td>
                        </tr>
                        <tr>
                          <td>
                            <strong>Fax</strong>
                          </td>
                          <td>{lastVariable.fax}</td>
                        </tr>
                        <tr>
                          <td>
                  ...
                  <div className="col-md-6 text-end">
                    ...
                    <table className="table table-bordered">
                      <tbody>
                        <tr>
                          <td>{lastVariable.etablissement_ar}</td>
                          <td>
                            <strong>المؤسسة</strong>
                          </td>
                        </tr>
                        <tr>
                          <td>{lastVariable.universite_ar}</td>
                          <td>
                            <strong>الجامعة</strong>
                          </td>
                        </tr>
                        <tr>
                          <td>{lastVariable.directeur_ar}</td>
                          <td>
                            <strong>المدير</strong>
                          </td>
                        </tr>
                        <tr>
                          <td>{lastVariable.secretaire_ar}</td>
                          <td>
                            <strong>الكاتب العام</strong>
                          </td>
                        </tr>
                        <tr>
                          <td>{lastVariable.gouvernorat_ar}</td>
                          <td>
                            <strong>الولاية</strong>
                          </td>
                        </tr>
                        <tr>
                          <td>{lastVariable.address_ar}</td>
                          <td>
