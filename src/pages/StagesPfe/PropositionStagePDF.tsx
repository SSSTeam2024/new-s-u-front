    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            <Text style={styles.title}>
              Proposition d'un Projet Fin d'Etude
            </Text>
          </View>
        </View>
        {stageDetails.encadrant_univ === null ? (
          <>
            <Text style={styles.text}>Enseignant encadreur : </Text>{" "}
            ............................
          </>
        ) : (
          <Text style={styles.text}>
            Enseignant encadreur : {stageDetails.encadrant_univ.prenom_fr}{" "}
            {stageDetails.encadrant_univ.nom_fr}
          </Text>
        )}

        <Text style={styles.text}>
          Type du sujet : {stageDetails.type_stage}
        </Text>
        ...
        {stageDetails.binome === null ? (
          <Text style={styles.text}>Nombre d'étudiants : 1</Text>
        ) : (
          <Text style={styles.text}>Nombre d'étudiants : 2</Text>
        )}
        <Text style={styles.text}>
          Nom et Prénom étudiant(e): {stageDetails.etudiant.prenom_fr}{" "}
          {stageDetails.etudiant.nom_fr}
        </Text>
        <Text style={styles.text}>Titre du P.F.E : {stageDetails.sujet}</Text>
        <View
          style={{
            paddingLeft: 30,
            paddingRight: 30,
