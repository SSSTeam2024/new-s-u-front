...
const ListeDossiersAdministratifsPersonnelsArchives = () => {
  document.title =
    "Liste Dossiers Administratifs Personnels Archivés | Smart University";
      ...
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumb
            ...
            pageTitle="Liste des dossiers personnels archivés"
          />
...
export default ListeDossiersAdministratifsPersonnelsArchives;
