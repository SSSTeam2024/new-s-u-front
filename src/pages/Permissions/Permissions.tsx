...
} from "features/userPermissions/userPermissionSlice";
...
const Permissions = () => {
  document.title = "Permissions | ENIGA";
                  ...
                  <Card.Header className="d-flex align-items-center bg-info-subtle text-white">
                    <Form.Check
                      ...
                      onChange={(e) => {
                        ...
                        Object.keys(groupedPermissions[section]).forEach(
                          (subSection) => {
                            groupedPermissions[section][subSection].forEach(
                              (permission) => {
