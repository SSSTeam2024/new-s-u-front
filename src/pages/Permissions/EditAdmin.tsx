                ...
                <Card className="mb-3" key={section}>
                  <Card.Header className="d-flex align-items-center bg-info-subtle text-white">
                    <Form.Check
                      ...
                      id={`section-${section}`}
                      label={section}
                      checked={Object.values(groupedPermissions[section]).every(
                        (subSection) =>
                      ...
                      onChange={(e) => {
                        ...
                        Object.values(groupedPermissions[section]).forEach(
                          (subSection) => {
                          ...
                          <Col lg={4} key={index} className="mb-3">
                            <div className="border p-2 rounded">
                              <div className="d-flex align-items-center mb-2">
                                <Form.Check
                                  ...
                                  checked={Object.values(
                                    groupedPermissions[section][subSection]
                                  ).every(
                                    (permission) => checkedState[permission._id]
                                  )}
                                  onChange={(e) => {
                              ...
                              <ul className="list-group">
                                {groupedPermissions[section][subSection].map(
                                  (permission) => (
                                    <li
                                      key={permission._id}
                                    ...
                                    >
                                      <Form.Check
                                        ...
                                        checked={
                                          checkedState[permission._id] || false
                                        }
                                      />
                                    </li>
                                  )
